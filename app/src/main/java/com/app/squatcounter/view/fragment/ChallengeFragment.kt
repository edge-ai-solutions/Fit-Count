...
import com.app.squatcounter.view.camera.CameraSource
import com.app.squatcounter.databinding.FragmentChallengeBinding
import com.app.squatcounter.view.dialog.ErrorDialog
import com.app.squatcounter.model.ChallengeViewModel
import com.app.squatcounter.util.ChallengeRepetitionCounter
import com.app.squatcounter.util.SharedPref
import com.app.squatcounter.util.VisualizationUtils.MODEL_HEIGHT
import com.app.squatcounter.util.VisualizationUtils.MODEL_WIDTH
    ...
    override fun onStart() {
        ...
        camera = CameraSource(surfaceView!!, object : CameraSource.CameraSourceListener {
            override fun onCalculate(bitmap: Bitmap) {
                ...
                activity?.runOnUiThread { SharedPref.getInstance(activity?.application)?.saveString("score",count.toString())}
            }
